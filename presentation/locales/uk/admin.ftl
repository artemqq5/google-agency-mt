...
ADMIN-SPECIFIC-LOAD-WARNING = Зараз буде запущено процес завантаження нових акаунтів з усіх доданих в бота MCC! При виконанні цього процесу акаунти яких ще немає в базі бота, будуть записані до відповідного MCC.

    <b>Натисніть тільки один раз, це ресурсозатратний процес</b>
ADMIN-SPECIFIC-LOAD-CONFIRMATION = Підтвердити завантаження
ADMIN-SPECIFIC-LOAD-PROCESSING = Почалося завантаження, буде йти близько 1-2 хвилин
