...
CLIENT-MCC-BALANCE-HASH-SEND = 📄❗ <b>надішліть хеш транзакції</b>:
CLIENT-MCC-BALANCE-HASH =  📄 Поповніть баланс на <b>{$sum}$</b>:

    ❗При поповненні менше вказаної суми, оплата не буде здійснена автоматично❗
...
CLIENT-WAIT_FOR_REQUEST = Зачекайте кілька секунд перед повторним запитом!
###########################################
