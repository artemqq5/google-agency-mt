...
NOTIFICATION-TEAM-COMMISSIONS_REPORT = Сообщение о комиссионном сборе 💸
    Количество комиссионных транзакций: {$taxes_count}
    Общая сумма: <b>{$taxes_amount} USD</b>

    Подробную информацию можно просмотреть в "Комиссионные транзакции"

    Аккаунты, к которым были применены комиссионные списания:
    {$emails_with_tax}
